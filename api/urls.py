...
router.register('medical-notes', views.MedicalNoteViewSet, basename='medical-note')
router.register('appointments', views.AppointmentViewSet, basename='appointment')
router.register('booking-series', views.BookingSeriesViewSet, basename='booking-series')
router.register('booking-groups', views.BookingGroupViewSet, basename='booking-group')
...
router.register('blocked-times', views.BlockedTimeViewSet, basename='blocked-time')
...
router.register(
    'dog-change-requests', views.DogChangeRequestViewSet,
    basename='dog-change-request',
)
