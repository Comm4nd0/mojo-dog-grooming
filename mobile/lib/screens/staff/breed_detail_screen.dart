  ...
  Future<void> _save() async {
    ...
    try {
      await _data.updateBreed(widget.breedId, {
        ...
        'typical_temperament': text('temperament'),
        'chest_shape': text('chest'),
        'head_type': text('headType'),
        'ear_shape': text('ear'),
        'tail_shape': text('tailShape'),
    ...
    return RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          ...
          // Jess's own note off the Kennel Club's pages, and the last line of
          // this section because it is the longest.
          DetailRow(label: 'Typical temperament', value: breed.typicalTemperament),
          ...
          DetailRow(label: 'Tail shape', value: breed.tailShape),
  ...
  Widget _form(Breed breed) {
    return ListView(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        _text('temperament', 'Typical temperament', breed.typicalTemperament, lines: 3),
        ...
        const SizedBox(height: 12),
        _text('tailShape', 'Tail shape', breed.tailShape),
        const SizedBox(height: 12),
